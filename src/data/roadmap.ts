  ...
  items: [
    {
      ...
      summary: localised(
        'Completing GP discovery and shaping a co-designed digital roadmap so the team has a clearer evidence base for future product direction.',
      ),
    ...
    },
    {
      ...
      summary: localised(
        'Progressing the WCCG and GPTR technology deep dive so current architecture, integrations, hosting, technical debt, operational risks and modernisation opportunities are understood.',
      ),
      categoryId: CATEGORY_ID,
      horizon: 'now',
      status: 'in-progress',
    ...
    },
    {
      ...
      summary: localised(
        'Running user discovery and user research across GPTR, WCCG, GP Portal and GP Links so roadmap priorities are shaped by service and user evidence.',
      ),
      categoryId: CATEGORY_ID,
      horizon: 'now',
      status: 'in-progress',
    ...
    },
    {
      ...
      summary: localised(
        'Supporting active GMS delivery priorities including AVT procurement, GMS Show and Tell, the GMS Resource Hub, One Advanced Exit, SNOMED support and cluster pilots.',
      ),
      categoryId: CATEGORY_ID,
      horizon: 'now',
      status: 'in-progress',
    ...
    },
    {
      ...
      summary: localised(
        'Enabling access to immunisations, problems and test results through NHS Wales App options so contract reform priorities can be progressed with Optum.',
      ),
      categoryId: CATEGORY_ID,
      horizon: 'next',
      status: 'exploring',
    ...
    },
    {
      ...
      summary: localised(
        'Moving AVT from procurement into a framework and call-off process, supported by T-Pro and Dragon Co-Pilot evaluation outputs.',
      ),
      categoryId: CATEGORY_ID,
      horizon: 'next',
      status: 'exploring',
    ...
    },
    {
      ...
      summary: localised(
        'Progressing WCCG and GPTR migration work, including VCF migration, UAT and production cloud migration planning, and the supporting migration plan.',
      ),
      categoryId: CATEGORY_ID,
      horizon: 'next',
      status: 'exploring',
    ...
    },
    {
      ...
      summary: localised(
        'Considering future EMIS Web and Optum roadmap items such as EMIS-X Browser, EMIS-X Companion App, Desktop Integration API, Dynamic Templates, Ardens, COLOFIT, ENOIDS and Structured Medicine Dosage Syntax.',
      ),
      categoryId: CATEGORY_ID,
      horizon: 'later',
      status: 'exploring',
    ...
    },
    {
      ...
      summary: localised(
        'Exploring future NHS Wales App enhancements, including proxy enhancements and GP IT registration, where these align to wider product direction.',
      ),
      categoryId: CATEGORY_ID,
      horizon: 'later',
      status: 'exploring',
